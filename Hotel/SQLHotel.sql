...
insert into NHANVIEN(TAIKHOAN, MATKHAU, TENNV, CCCD, LOAINV, SDT, NGSINH)
values ('nv1', 'a', N'Khôi ngu', '123123123', 1, '0123123321', '2003-10-21')
insert into NHANVIEN(TAIKHOAN, MATKHAU, TENNV, CCCD, LOAINV, SDT, NGSINH)
values ('nv2', 'a', N'Nguyễn Lê', '554455446', 2, '0125423321', '2004-11-21')
insert into NHANVIEN(TAIKHOAN, MATKHAU, TENNV, CCCD, LOAINV, SDT, NGSINH)
values ('nv3', 'a', N'Hò Thị Nở', '839472856', 2, '0593958341', '2002-9-30')
insert into NHANVIEN(TAIKHOAN, MATKHAU, TENNV, CCCD, LOAINV, SDT, NGSINH)
values ('nv4', 'a', N'Trương Văn Nghị', '045203331', 1, '058374851', '2003-5-1')
insert into NHANVIEN(TAIKHOAN, MATKHAU, TENNV, CCCD, LOAINV, SDT, NGSINH)
values ('nv5', 'a', N'Tống Thị Khôi', '573968374', 2, '047247584', '1999-7-13')
insert into NHANVIEN(TAIKHOAN, MATKHAU, TENNV, CCCD, LOAINV, SDT, NGSINH)
values ('nv6', 'a', N'A Di Phò Phò', '683756384', 2, '0368194728', '2002-1-2')
insert into NHANVIEN(TAIKHOAN, MATKHAU, TENNV, CCCD, LOAINV, SDT, NGSINH)
values ('nv7', 'a', N'Kiệt Di Lặc', '673849263', 2, '0374816235', '2000-10-10')
insert into NHANVIEN(TAIKHOAN, MATKHAU, TENNV, CCCD, LOAINV, SDT, NGSINH)
values ('nv8', 'a', N'Cù Lao', '582749374', 1, '0361726325', '2002-5-11')
...
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P101', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P102', N'Thường', N'Tu sửa')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P103', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P104', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P105', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P106', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P107', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V101', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V102', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V103', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V104', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V105', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V106', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P201', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P202', N'Thường', N'Tu sửa')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P203', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P204', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P205', N'Thường', N'Tu sửa')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P206', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'P207', N'Thường', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V201', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V202', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V203', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V204', N'Vip', N'Tu sửa')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V205', N'Vip', N'Bình thường')
insert into PHONG(TENPHONG, LOAIPHONG, TRANGTHAI)
values (N'V206', N'Vip', N'Bình thường')
